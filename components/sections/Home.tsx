...
export const Home: React.FC<HomeProps> = ({ setPage }) => {
  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-in-out]">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <button 
              ...
              className="w-full sm:w-auto px-10 py-4 bg-transparent border border-white/30 hover:bg-white/10 text-white rounded-sm backdrop-blur-sm transition-all duration-300 text-lg flex items-center justify-center gap-3 font-medium"
            >
              <TabletSmartphone className="w-5 h-5" /> View Access Guide
            </button>
          </div>
        </div>
      </div>
      ...
      {/* Problem & Solution */}
      <section className="py-24 bg-[#112240] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <img 
                src="https://raw.githubusercontent.com/mlight00/MAK_membership/main/body.png" 
...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
  <div className="bg-[#112240] p-10 rounded-sm hover:bg-[#1a3055] transition-colors border border-white/5 hover:border-accent/30 group">
