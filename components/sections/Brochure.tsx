      ...
      <div className="max-w-[210mm] mx-auto bg-[#0A192F] shadow-2xl print:shadow-none min-h-[297mm] flex flex-col font-sans overflow-hidden">
        ...
        <div className="pt-[15mm] pb-[5mm] px-[15mm] text-center bg-[#0A192F] relative z-20">
           <div className="mb-6 flex justify-center">
              <span className="bg-[#D32F2F] text-white px-4 py-1 text-xs font-bold uppercase tracking-[0.2em] rounded-sm">Limited Access Now Open</span>
           </div>
        ...
        <div className="relative flex-grow flex flex-col justify-between">
            ...
            {/* Content 1: The 3 Cards (Moved to Top) */}
            ...
            {/* Content 2: Precision over Volume (Moved Middle, Stacked Vertically with Side Bar) */}
            ...
            {/* Footer */}
            <div className="relative z-10 p-[15mm] mt-auto border-t border-white/10 flex justify-between items-end bg-[#050d1a]/90 backdrop-blur">
               <div>
                 <p className="text-gray-500 text-[10px] mb-1 uppercase tracking-widest">Official Registration</p>
                 <p className="text-[#D32F2F] font-bold text-lg font-serif">www.medicalaesthetickorea.com/member</p>
               </div>
