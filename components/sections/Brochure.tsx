  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8 print:py-0 print:m-0 text-white animate-[fadeIn_0.5s_ease-in-out]">
      ...
      <div className="max-w-[210mm] mx-auto bg-[#0A192F] shadow-2xl print:shadow-none print:w-full print:max-w-none print:mx-0 min-h-[297mm] flex flex-col font-sans overflow-hidden">
        ...
        <div className="pt-[10mm] pb-[2mm] px-[15mm] text-center bg-[#0A192F] relative z-20">
           <div className="mb-4 flex justify-center">
              <span className="bg-[#D32F2F] text-white px-5 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] rounded-sm">Limited Access Now Open</span>
           </div>
        ...
        <div className="relative flex-grow flex flex-col justify-between">
            ...
            <div className="relative z-10 px-[15mm] mb-6">
              <div className="flex bg-[#112240]/50 border border-white/5 rounded-lg overflow-hidden">
                  {/* Red Bar Indicator */}
                  <div className="w-1.5 bg-[#D32F2F] flex-shrink-0"></div>
               ...
               <div className="grid grid-cols-4 gap-3 relative">
                  ...
                  {[
                    ...
                    <div key={item.step} className="text-center relative z-10 group">
                       ...
                       <h3 className="font-bold text-[9px] text-white mb-1">{item.title}</h3>
            ...
            <div className="relative z-10 px-[15mm] py-[5mm] mt-auto border-t border-white/10 flex justify-between items-end bg-[#050d1a]/90 backdrop-blur">
               <div>
                 <p className="text-gray-500 text-[8px] mb-1 uppercase tracking-widest">Official Registration</p>
                 <p className="text-[#D32F2F] font-bold text-xs font-serif">www.medicalaesthetickorea.com/member</p>
               </div>
               <div className="text-right">
                  <img src="https://raw.githubusercontent.com/mlight00/MAK_membership/main/logo.png?raw=true" alt="Logo" className="h-4 w-auto opacity-70 mb-1 ml-auto" />
